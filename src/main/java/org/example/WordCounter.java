...
public class WordCounter {
    ...
    // Metot ismi test sınıfındaki gibi "calculatedWord" ve parametresiz yapılmıştır.
    public static Map<String, Integer> calculatedWord() {
        ...
        // Noktalama işaretlerini temizler (Türkçe karakter duyarlılığı dahil) ve küçük harfe çevirir
